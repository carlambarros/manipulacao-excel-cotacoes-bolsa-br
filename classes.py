...
class LeitorAcoes:
    ...
    def processa_arquivos(self, acao: str):
        with open(f'{self.caminho_arquivo}{acao.upper()}.txt', 'r') as arquivo_cotacao:
...
class GerenciadorPlanilha:
    ...
    def adiciona_grafico_linha(self, celula: str, comprimento: float, altura: float,
                               titulo_grafico: str, titulo_eixo_x: str, titulo_eixo_y: str,
    ...
    def adiciona_imagem(self, caminho_imagem: str, celula: str):
